        ...
        <body>
        <h1>Hello</h1>
        <form:form method="post" action="/product/add" modelAttribute="product1">
                    Ma:<input type="text" name="ma"><br>
                    Ten: <input type="text" name="tenSanPham"><br>
                    Loai giay:<select name="loaiGiay">
                        <c:forEach var="item" items="${loaiDay}">
                            <option value="${item.id}"><c:out value="${item.tenTheLoai}"/></option>
                        </c:forEach>
                    </select><br>
                    Anh:<input type="text" name="photo"><br>
                    Gia:<input type="text" name="price"><br>
                    Trang thai:<input type="text" name="trangThai"><br>
                    <br/>
