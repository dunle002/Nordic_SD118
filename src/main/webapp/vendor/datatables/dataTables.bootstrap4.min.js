    ...
    f.ext.renderer.pageButton.bootstrap = function (a, h, r, s, j, n) {
        var o = new f.Api(a),
            ...
            q = function (d, f) {
                ...
                l = 0;
                for (h = f.length; l < h; l++) if (b = f[l], Array.isArray(b)) q(d, b); else {
                    g = e = "";
                    switch (b) {
                        case "ellipsis":
                            e = "&#x2026;";
                    ...
                    e && (i = c("<li>", {
                        ...
                        "class": "page-link"
                    }).html(e)).appendTo(d), a.oApi._fnBindAction(i, {action: b}, m), p++)
                }
            }, i;
        try {
        ...
        c(h).find('.page-link').each(function () {
            var pageNumber = parseInt(c(this).text());
            if (!isNaN(pageNumber)) {
